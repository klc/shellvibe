...
abstract interface class DeviceLinkSessionTransport {
  ...
  /// Attaches [connection] to this session. Desktop and phone then share the
  /// session: both write to the same process and both see its output. Nothing
  /// the desktop does takes the session back — only an explicit detach, from
  /// either end, ends the sharing.
