...
/// Auto-disposing provider for [McpDao].

@ProviderFor(mcpDao)
final mcpDaoProvider = McpDaoProvider._();

/// Auto-disposing provider for [McpDao].

final class McpDaoProvider extends $FunctionalProvider<McpDao, McpDao, McpDao>
    with $Provider<McpDao> {
  /// Auto-disposing provider for [McpDao].
  McpDaoProvider._()
    : super(
        from: null,
  ...
  @override
  String debugGetCreateSourceHash() => _$mcpDaoHash();

  @$internal
  @override
  $ProviderElement<McpDao> $createElement($ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  McpDao create(Ref ref) {
    return mcpDao(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(McpDao value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<McpDao>(value),
    );
  }
}
