...
class _SshConfigImportDialogState extends ConsumerState<SshConfigImportDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return ShadDialog(
      // The preview lists one row per parsed host, so it asks for more than
      // shadcn's 512px default. A constraint shrinks on a phone; the fixed
      // width this replaced was clamped away on every screen.
      ...
      actions: adaptiveDialogActions(context, [
        ...
        ShellVibeButton(
          ...
          label: 'Import',
          onPressed: _selectedAliases.isEmpty ? null : _runImport,
          busy: _importing,
        ),
      ]),
